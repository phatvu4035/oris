odoo.define('oristar_ecommerce_website.ProductSearch', function (require) {
    "use strict";
    ...
    var ShapeType = require('oristar_ecommerce_website.ShapeType');
    var Alloy = require('oristar_ecommerce_website.Alloy');
    var Material = require('oristar_ecommerce_website.Material');
    var MaterialCategory = require('oristar_ecommerce_website.MaterialCategory');
    var Stiffness = require('oristar_ecommerce_website.Stiffness');
    var Origin = require('oristar_ecommerce_website.Origin');
    var DetailShape = require('oristar_ecommerce_website.DetailShape');
